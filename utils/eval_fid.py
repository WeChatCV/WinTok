...
from data.dataset import PlainDataset, normalize_01_into_pm1
from utils.config import Args


def eval_fid(vae, dir_raw, dir_recon, feature_extractor_path, vae_bs):
    vae.eval()
    ...
    for file_names, imgs in tqdm(dataloader):
        ...
        with torch.no_grad():
            rec_imgs = vae.img_to_reconstructed_img(imgs, vae_bs)
